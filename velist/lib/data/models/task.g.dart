...
void _taskSerialize(
  ...
  writer.writeByte(offsets[7], object.priority);
...
Task _taskDeserialize(
  ...
  final object = Task(
    ...
    hasTime: reader.readBoolOrNull(offsets[4]) ?? false,
    isCompleted: reader.readBoolOrNull(offsets[5]) ?? false,
    parentUuid: reader.readStringOrNull(offsets[6]),
    priority: reader.readByteOrNull(offsets[7]) ?? 0,
...
extension TaskQueryWhereSort on QueryBuilder<Task, Task, QWhere> {
  ...
  QueryBuilder<Task, Task, QAfterWhere> anyIsCompleted() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension TaskQueryWhere on QueryBuilder<Task, Task, QWhereClause> {
  ...
  QueryBuilder<Task, Task, QAfterWhereClause> isCompletedEqualTo(
      bool isCompleted) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<Task, Task, QAfterWhereClause> isCompletedNotEqualTo(
      bool isCompleted) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Task, Task, QAfterWhereClause> parentUuidIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<Task, Task, QAfterWhereClause> parentUuidIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'parentUuid',
        lower: [null],
  ...
  QueryBuilder<Task, Task, QAfterWhereClause> parentUuidEqualTo(
      String? parentUuid) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'parentUuid',
  ...
  QueryBuilder<Task, Task, QAfterWhereClause> parentUuidNotEqualTo(
      String? parentUuid) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension TaskQueryFilter on QueryBuilder<Task, Task, QFilterCondition> {
  ...
  QueryBuilder<Task, Task, QAfterFilterCondition> hasTimeEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'hasTime',
        value: value,
...
extension TaskQuerySortBy on QueryBuilder<Task, Task, QSortBy> {
  ...
  QueryBuilder<Task, Task, QAfterSortBy> sortByHasTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hasTime', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> sortByHasTimeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskQuerySortThenBy on QueryBuilder<Task, Task, QSortThenBy> {
  ...
  QueryBuilder<Task, Task, QAfterSortBy> thenByHasTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hasTime', Sort.asc);
    });
  }

  QueryBuilder<Task, Task, QAfterSortBy> thenByHasTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'hasTime', Sort.desc);
    });
  }
...
extension TaskQueryWhereDistinct on QueryBuilder<Task, Task, QDistinct> {
  ...
  QueryBuilder<Task, Task, QDistinct> distinctByHasTime() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskQueryProperty on QueryBuilder<Task, Task, QQueryProperty> {
  ...
  QueryBuilder<Task, bool, QQueryOperations> hasTimeProperty() {
    return QueryBuilder.apply(this, (query) {
